...
import com.cinema.core.service.bt.selectors.DraftFilesSelector;
...
public class BtService {
    ...
    private final Storage storage = new FileSystemStorage(Paths.get(com.cinema.core.config.Config.getPreference(com.cinema.core.config.Config.PrefKey.STORAGE)));
